...
const XX99MarkI: ProductProps = {
  ...
  productTarget: '/product/XX99MarkI',
  productFeatures: [
  ...
  productPrice: 1_750,
  productGallery: XX99MarkIGallery,
  poroductInBox: [
    { 'Headphone Unit': 1 },
  ...
  newProduct: true,
  productImgWihtoutShadow: XX99MarkIImagesWithoutShadow,
  productCategory: 'headphones',
  productIcon: XX99MKIMobileImg,
};
