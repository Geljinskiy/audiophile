...
const XX99MarkII: ProductProps = {
  ...
  productTarget: '/product/XX99MarkII',
  productFeatures: [
  ...
  productPrice: 2_999,
  productGallery: XX99MarkIIGallery,
  poroductInBox: [
    { 'Headphone Unit': 1 },
  ...
  newProduct: true,
  productImgWihtoutShadow: XX99MarkIIImagesWithoutShadow,
  productCategory: 'headphones',
  productIcon: XX99MKIIMobileImg,
};
